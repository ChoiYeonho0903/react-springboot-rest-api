...
function App() {
  const [products, setProducts] = useState([
    {id: 'uuid-1', productName: '콜롬비아 커피 1', categroy: '커피콩', price: 5000},
    {id: 'uuid-2', productName: '콜롬비아 커피 2', categroy: '커피콩', price: 5000},
    {id: 'uuid-3', productName: '콜롬비아 커피 3', categroy: '커피콩', price: 5000}
  ]);
